//
//  SharedParkingSpaceTableViewController.swift
//  SSASideMenuStoryboardExample
//
//  Created by BennyO on 27/4/2017.
...
class SharedParkingSpaceTableViewController: UITableViewController {
    
    var sharedParkingSpace:[PFObject] = []
